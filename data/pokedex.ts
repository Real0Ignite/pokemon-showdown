...
//	},
    ...
    num: 114,
		...
		forme: "Lokura",
    types: ["Grass", "Dark"],
    baseStats: {hp: 65, atk: 55, def: 40, spa: 100, spd: 115, spe: 55},
	...
	crystalouros: {
		...
		abilities: {0: "Rough Skin", 1: "Solid Rock", H: "Weak Armor"},
		heightm: 2.4,
		weightkg: 282.8,
		color: "Purple",
		eggGroups: ["Monster"],
...
nebuluga: {
	...
	grumpiglokura: {
		...
		abilities: {0: "Technician", 1: "Adaptability", H: "Emergency Exit"},
		heightm: 0.9,
		weightkg: 65.7,
		color: "Black",
		prevo: "Spoink",
